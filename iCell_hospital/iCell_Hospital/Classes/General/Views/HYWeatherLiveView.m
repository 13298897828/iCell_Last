...
#import "HYWeatherLiveView.h"

@interface HYWeatherLiveView ()
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        if ([[DBManager sharedManager]findLiveWeatherInformationInDatabase].allKeys.count) {
