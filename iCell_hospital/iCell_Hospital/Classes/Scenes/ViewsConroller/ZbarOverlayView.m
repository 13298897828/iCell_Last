...
- (void)addLine
{
    _imgLine = [[UIImageView alloc] initWithFrame:CGRectMake(50, 0, self.transparentArea.size.width - 100, 2)];
    _imgLine.image = [UIImage imageNamed:@"zbar-line"];
      CGRect r = [ UIScreen mainScreen ].applicationFrame;
    _imgLine.center = CGPointMake(r.size.width / 2, _rectY + 2);
